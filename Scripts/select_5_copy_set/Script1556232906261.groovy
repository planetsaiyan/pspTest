...
WebUI.selectOptionByLabel(findTestObject('choosing_plan_set/select_Plan_set'), '\\s*[5].+(Copy).+(Set).+', true)

WebUI.click(findTestObject('Object Repository/choosing_plan_set/button_Add to Cart'))

WebUI.click(findTestObject('Object Repository/choosing_plan_set/div_Plan Set5 Copy Set'))

WebUI.delay(2)
def actualString = WebUI.getText(findTestObject('Object Repository/choosing_plan_set/div_Plan Set5 Copy Set'))
WebUI.verifyMatch(actualString, '.*(5\\sCopy\\sSet).*', true)
